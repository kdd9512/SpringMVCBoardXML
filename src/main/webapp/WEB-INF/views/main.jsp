            ...
            <div class="col-lg-6" style="margin-top:20px">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <table class="table table-hover" id='board_list'>
                            ...
                            <c:forEach var="obj" items="${sub_list}">
                                <tr>
                                    ...
                                    <th>
                                        <a href='<c:url value="/board/read?board_info_idx=${board_list[idx.index].board_info_idx}&content_idx=${obj.content_idx}&page=1"/>'>
                        ...
                        <a href="<c:url value="/board/main?board_info_idx=${board_list[idx.index].board_info_idx}&page=1"/>" class="btn btn-primary">더보기</a>
                    </div>
                </div>
            </div>
        </c:forEach>
