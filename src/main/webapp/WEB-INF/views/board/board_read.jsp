            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <img src="image/logo.png" width="100%" id="board_file1"/>
                    </div>
                    <div class="form-group">
                        <div class="text-right">
                            <a href="<c:url value="/board/main"/>" class="btn btn-primary">목록보기</a>
                            <a href="<c:url value="/board/board_modify"/>" class="btn btn-info">수정하기</a>
                            <a href="<c:url value="/board/board_remove"/>" class="btn btn-danger">삭제하기</a>
                        </div>
                    </div>
                </div>
            </div>
